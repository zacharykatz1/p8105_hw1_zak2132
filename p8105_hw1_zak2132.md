...
```
    ...
    ## 1  -0.24625039          FALSE                s         first
    ## 2   0.09380128           TRUE                t        second
    ## 3   1.03260920           TRUE                r         third
    ## 4   2.12804456           TRUE                a         first
    ## 5  -0.48361947          FALSE                w        second
    ## 6  -1.36110198          FALSE                b         third
    ## 7   0.44869515           TRUE                e         first
    ## 8  -1.57179349          FALSE                r        second
    ## 9   1.58103401           TRUE                r         third
    ## 10  0.63486152           TRUE                y         first
...
```
    ...
    ##  $ rand_sample     : num  -0.2463 0.0938 1.0326 2.128 -0.4836 ...
    ##  $ logical_vector  : logi  FALSE TRUE TRUE TRUE FALSE FALSE ...
...
-   The mean of the random sample is 0.225628 and the mean of the
