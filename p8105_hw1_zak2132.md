...
```
    ...
    ## 1   -0.6221966          FALSE                s         first
    ## 2   -0.6883654          FALSE                t        second
    ## 3   -0.6718647          FALSE                r         third
    ## 4   -0.7844563          FALSE                a         first
    ## 5    2.4921612           TRUE                w        second
    ## 6   -0.5722582          FALSE                b         third
    ## 7   -0.2518532          FALSE                e         first
    ## 8    0.3266742           TRUE                r        second
    ## 9   -0.8450337          FALSE                r         third
    ## 10   0.7761055           TRUE                y         first
...
```
    ...
    ##  $ rand_sample     : num  -0.622 -0.688 -0.672 -0.784 2.492 ...
    ##  $ logical_vector  : logi  FALSE FALSE FALSE FALSE TRUE FALSE ...
...
-   The mean of the random sample is -0.0841087 and the mean of the
