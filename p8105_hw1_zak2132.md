...
```
    ...
    ## 1    0.3402071           TRUE                s         first
    ## 2    0.5745124           TRUE                t        second
    ## 3    1.5938114           TRUE                r         third
    ## 4    1.4491152           TRUE                a         first
    ## 5   -0.5027976          FALSE                w        second
    ## 6    1.4912740           TRUE                b         third
    ## 7    1.4447956           TRUE                e         first
    ## 8    0.2521112           TRUE                r        second
    ## 9   -0.1381692          FALSE                r         third
    ## 10   0.5458905           TRUE                y         first
...
```
    ...
    ##  $ rand_sample     : num  0.34 0.575 1.594 1.449 -0.503 ...
    ##  $ logical_vector  : logi  TRUE TRUE TRUE TRUE FALSE TRUE ...
...
-   The mean of the random sample is 0.7050751 and the mean of the
