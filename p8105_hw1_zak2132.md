...
```
    ...
    ## 1  -0.99587448          FALSE                s         first
    ## 2   0.37462257           TRUE                t        second
    ## 3   1.49093718           TRUE                r         third
    ## 4   0.85448711           TRUE                a         first
    ## 5   0.55602168           TRUE                w        second
    ## 6   0.06785469           TRUE                b         third
    ## 7  -0.25939670          FALSE                e         first
    ## 8  -1.08671967          FALSE                r        second
    ## 9   0.25821189           TRUE                r         third
    ## 10 -1.76142493          FALSE                y         first
...
```
    ...
    ##  $ rand_sample     : num  -0.996 0.375 1.491 0.854 0.556 ...
    ##  $ logical_vector  : logi  FALSE TRUE TRUE TRUE TRUE TRUE ...
...
-   The mean of the random sample is -0.0501281 and the mean of the
    logical vector is 0.6, which is the proportion of the random sample
...
``` r
# Try another neat tool to show data distribution by column
skimr::skim(penguins)
```
